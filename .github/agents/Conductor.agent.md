---
name: Conductor
description: Orchestrator agent that coordinates Coder, TestPlanner, and Tester agents to deliver end-to-end Java Spring Boot feature development workflows for the QA-ISystem project.
---
