...
public class ApiTestRunner {
    ...
    /**
     * Builds a Javadoc comment block section from the PR's external context
     * (Jira tickets, Confluence links, labels, products) so the context is
     * embedded directly in the generated test file for human reference.
     */
